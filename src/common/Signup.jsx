  ...
  return (
    <div className="bg-white rounded-lg shadow-xl overflow-hidden">
      ...
      <div className="bg-orange-800 p-6 text-white">
        ...
        <p className="text-center text-orange-100 mt-1">Join our recipe community</p>
      </div>
      ...
      <div className="p-6">
        <form onSubmit={handleSubmit}>
          <div className="space-y-4">
            ...
            <div className="relative">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-10 pr-10 py-2 w-full border border-gray-300 rounded-md focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
                  placeholder="••••••••"
                  required
                />
                <button
            ...
            <button
              type="submit"
              className="w-full bg-orange-800 text-white py-2 px-4 rounded-md hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 transition duration-200"
            >
              Create Account
            </button>
          </div>
